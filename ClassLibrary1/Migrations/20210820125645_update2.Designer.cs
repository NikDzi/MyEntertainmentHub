...
namespace ClassLibrary1.Migrations
{
    ...
    [Migration("20210820125645_update2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassLibrary1.Model.Bans", b =>
                {
            ...
            modelBuilder.Entity("ClassLibrary1.Model.CommentReports", b =>
                {
            ...
            modelBuilder.Entity("ClassLibrary1.Model.Media", b =>
                {
                    ...
                    b.Property<int?>("TechnicalSpecificationsID1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TechnicalSpecificationsID1");

                    b.HasIndex("WatchListMediaID");
            ...
            modelBuilder.Entity("ClassLibrary1.Model.MistakeTickets", b =>
                {
                    ...
                    b.Property<string>("IdentityTestValue")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ClassLibrary1.Model.CommentReports", b =>
                {
                    b.HasOne("ClassLibrary1.Model.Comments", "Comment")
                        .WithMany("RUID")
            ...
            modelBuilder.Entity("ClassLibrary1.Model.Comments", b =>
                {
                    ...
                    b.HasOne("ClassLibrary1.Model.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassLibrary1.Model.Media", b =>
                {
                    ...
                    b.HasOne("ClassLibrary1.Model.TechnicalSpecifications", "TechnicalSpecifications")
                        .WithMany()
                        .HasForeignKey("TechnicalSpecificationsID1");

                    b.HasOne("ClassLibrary1.Model.WatchListMedia", null)
                        .WithMany("Media")
                        .HasForeignKey("WatchListMediaID");
                });
